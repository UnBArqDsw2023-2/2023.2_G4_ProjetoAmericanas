...
<div align="justify">
&emsp;&emsp;A visão de implementação representa a disposição dos módulos de software estáticos, os quais incluem código-fonte, arquivos de dados, executáveis e documentação, no ambiente de desenvolvimento. Isso é abordado em termos de:</div>

- Organização em embalagens e camadas
- Gestão de configuração, abordando propriedades e estratégias de liberação

<div align="justify">
&emsp;&emsp;É relevante ressaltar que a visão de implementação concentra-se na tradução da visão lógica, suas entidades, para componentes concretos de software.</div>

### 7.1. Visão geral


<div align="justify">
&emsp;&emsp;Para a modelagem deste artefato, reutilizamos o <a href="https://unbarqdsw2023-2.github.io/2023.2_G4_ProjetoAmericanas/#/Modelagem/Estaticos/componentes">diagrama de componentes</a> anteriormente feito pelo grupo, que teve como base o artefato de <a href="https://unbarqdsw2023-2.github.io/2023.2_G4_ProjetoAmericanas/#/Base/richPicture">Rich Picture</a>, fazendo suas devidas correções com objetivo de melhor representar o fluxo e trazer uma melhor visão da implementação do sistema.</div>
